...
var FormFieldContainer = function FormFieldContainer(_ref) {
  var _ref$fullWidth = _ref.fullWidth,
      fullWidth = _ref$fullWidth === void 0 ? true : _ref$fullWidth,
      className = _ref.className,
      children = _ref.children,
      props = _objectWithoutPropertiesLoose(_ref, ["fullWidth", "className", "children"]);
...
var Select = function Select(_ref) {
  var _ref$fullWidth = _ref.fullWidth,
      ...
      id = _ref.id,
      props = _objectWithoutPropertiesLoose(_ref, ["fullWidth", "className", "options", "id"]);
